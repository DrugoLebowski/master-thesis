\include{introduction}\include{sl-nn}\include{nram}\include{de}\include{conclusion}\include{experiments}\include{implementation}% Classe appositamente creata per tesi di Ingegneria Informatica all'università Roma Tre
\documentclass{TesiValerio}


% --- INIZIO dati relativi al template TesiDiaUniroma3
% dati obbligatori, necessari al frontespizio
\titolo{DE-NRAM: an differential evolutionary approach}
\autore{Valerio Belli}
\matricola{283514}
\relatore{Prof.ssa Valentina Poggioni Prof. Marco Baioletti}
...
\capitolo{Neural networks}{neural-networks}
