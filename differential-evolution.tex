...
\subsubsection{Bin}
\begin{figure}[h]
	%\includegraphics[width=0.5\textwidth]{figures/bin-crossover.png}
...
\end{align} 
where $< \cdot >_{D}$ is the modulo function with modulus D. An visual example is showed in figure \ref{fig:exp-crossover}
