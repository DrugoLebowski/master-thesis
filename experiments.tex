...
\end{figure}
As showed in the Table \ref{tbl:tests-results}, the easy tasks are learned satisfactorily, reaching the same results of the paper even using shorter sequences $A$ for the training. \newline
**************\newline
TODO\newline
**************
